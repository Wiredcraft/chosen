...
class Chosen extends AbstractChosen
  ...
  set_up_html: ->
    ...
    if @is_multiple
      ...
      container_div.html '<a href="" class="chzn-single chzn-default"><span>' + @default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>'
  ...
  choice_build: (item) ->
    ...
    @choices += 1
    @search_container.before  '<li class="search-choice" id="' + choice_id + '"><span>' + item.html + '</span><a href="" class="search-choice-close" rel="' + item.array_index + '"></a></li>'
